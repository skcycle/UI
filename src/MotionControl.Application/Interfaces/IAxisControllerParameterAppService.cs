...
public interface IAxisControllerParameterAppService
{
    ...
    Task<DeviceResult> WriteControllerParametersAsync(int axisNo, double workVelocity, double setupVelocity, double pulseEquivalent, CancellationToken cancellationToken = default);
}
